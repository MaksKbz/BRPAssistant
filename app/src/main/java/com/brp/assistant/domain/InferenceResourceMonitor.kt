 ...
 * Интегрируется в ChatViewModel для защиты от OOM.
 *
 * На устройствах < 3 ГБ RAM (Tecno Spark, Itel A70, Redmi 9)
 * предотвращает OOM при запуске тяжёлых моделей с недостаточным запасом.
 */
@Singleton
